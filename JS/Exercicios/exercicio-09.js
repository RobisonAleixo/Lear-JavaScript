...
function classificacao(nota) {
    ...
    if (notaArredondada >= 40) {
        return 'Aprovado - Nota final: ' + notaArredondada;
    } else {
        return 'Reprovado - Nota final: ' + notaArredondada;
    }
    
}

console.log(classificacao(34));
console.log(classificacao(35));
console.log(classificacao(38));
console.log(classificacao(81));
console.log(classificacao(89));